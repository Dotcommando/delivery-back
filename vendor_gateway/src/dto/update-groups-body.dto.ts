...
export class UpdateGroupsBodyDto {
  ...
  @IsOptional()
  @IsArray({ message: 'Field \'add\' must contain array of pairs roles and companies (field \'group\') ObjectIds' })
  ...
  @IsOptional()
  @IsArray({ message: 'Field \'update\' must contain array of pairs roles and companies (field \'group\') ObjectIds' })
  @ValidateNested({ each: true })
  @ArrayMaxSize(COMPANIES_MAX_SIZE)
  @Type(() => MembershipDto)
  ...
  @IsOptional()
  @IsArray({ message: 'Field \'delete\' must contain array of companies ObjectIds to delete' })
  @ArrayMaxSize(COMPANIES_MAX_SIZE)
