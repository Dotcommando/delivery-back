...
export class CreateBrandSuccessResponseDto implements IResponse<ICreateBrandRes> {
  ...
  @ApiProperty({
    example: {
      brand: {
        ...
        backgroundLight: 'brand-background-light.jpg',
        backgroundDark: 'brand-background-dark.jpg',
        logo: 'brand-logo.jpg',
        translations: [
          {
            lang: 'hy',
