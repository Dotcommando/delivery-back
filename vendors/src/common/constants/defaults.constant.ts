...
export const VENDORS_DB_PORT = parseInt(process.env.VENDORS_DB_PORT);
export const VENDORS_DB_DSN = process.env.VENDORS_DB_DSN
  ...
  .replace('${VENDORS_DB_PORT}', String(VENDORS_DB_PORT));
